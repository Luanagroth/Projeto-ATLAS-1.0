  ...
  return (
    <section className="space-y-5">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h2 className="text-lg font-semibold">Modelos aplicados à auditoria</h2>
          <p className="text-sm text-muted-foreground">
            Aplique modelos e registre respostas sem alterar os templates.
          </p>
        </div>
      </div>
      ...
      {canExecute && templates.length === 0 ? (
        <p className="rounded-lg border border-dashed bg-card p-5 text-sm text-muted-foreground">
          Nenhum modelo ativo disponivel para aplicar nesta auditoria.
        </p>
      ) : null}
      ...
      {appliedChecklists.length > 0 ? (
        ...
        <div className="rounded-lg border border-dashed bg-card p-8 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-muted-foreground">
            Aplique um modelo para copiar seus itens e iniciar a execucao da
            auditoria.
          </p>
        </div>
      )}
